...
function countPrinterErrors(str) {
  // your solution here
  // verify string for correct letters
  // if incorrect letters exist - count how many out of total of string length
  // return how many errors/string length as result
  let regex = /[^a-m]/g
  // test to see if no errors


  let errors = str.match(regex);
  let errorCount = errors ? errors.length : 0; //check errors isn't null
